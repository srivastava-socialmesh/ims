      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <header className="flex justify-between items-center px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          ...
          <div className="flex gap-2 sm:gap-3">
            <Link
              href="/login"
              className="px-3 sm:px-5 py-1.5 sm:py-2 text-sm font-medium text-gray-800 hover:text-gray-900 transition-colors bg-white/70 backdrop-blur-sm rounded-full hover:bg-white/90 shadow-sm"
            >
              Sign In
            </Link>
            <Link
